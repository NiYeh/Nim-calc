...
panel.backgroundColor = wBlueViolet
...
box1.backgroundColor = wGreen
box2.backgroundColor = wYellowGreen
box3.backgroundColor = wGreenYellow

btn0.backgroundColor = wPurple
